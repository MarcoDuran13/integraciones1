...
public class RequestAuditProcessor
  implements Processor
{
  ...
  {
    org.apache.cxf.message.Message cxfMessage = (org.apache.cxf.message.Message)exchange.getIn().getHeader("CamelCxfMessage", org.apache.cxf.message.Message.class);
